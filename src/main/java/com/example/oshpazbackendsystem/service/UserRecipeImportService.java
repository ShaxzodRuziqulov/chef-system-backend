 ...
 *   5=qiyinlik   6=tayyorgarlik_min*  7=pishirish_min*  8=porsiya*  9=teglar
 *
...
public class UserRecipeImportService {
    ...
    public BulkImportResultDto importFromExcel(MultipartFile file, String mode) throws IOException {
        ...
        // mode=UPDATE faqat ADMIN uchun ruxsat
        if (doUpdate) {
    ...
    public byte[] exportToExcel() throws IOException {
        ...
        // Lazy kolleksiyalarni ochish — tranzaksiya davomida
    ...
    private byte[] buildExportWorkbook(List<Recipe> recipes) throws IOException {
        try (Workbook wb = new XSSFWorkbook();
            ...
            setWidths(s1, new int[]{5500, 5000, 5000, 9000, 4000, 3500, 4500, 4000, 3200, 5000});
    ...
    // Sheet 1 ustunlari:
    //   0=title_uz*  1=title_ru  2=title_eng  3=tavsif  4=kategoriya
    //   5=qiyinlik   6=prep*     7=cook*       8=servings*  9=teglar
    // ─────────────────────────────────────────────────────────────────────────
    ...
    public byte[] generateTemplate(String lang) throws IOException {
        ...
        try (Workbook wb = new XSSFWorkbook();
            ...
            String[] h1, h2, h3;
            String recipeNameUz, recipeNameRu, recipeNameEng, recipeDesc, diffVal, tagExample;
            ...
            if ("ru".equals(l)) {
                ...
                h1 = new String[]{"Название (UZ) *", "Название (RU)", "Название (EN)",
                ...
                h1 = new String[]{"Title (UZ) *", "Title (RU)", "Title (EN)",
                ...
                h1 = new String[]{"Nomi (UZ) *", "Nomi (RU)", "Nomi (EN)",
    ...
    /** Vergul bilan ajratilgan tag nomlarini ID ga o'giradi. Mavjud bo'lmaganlar o'tkazib yuboriladi. */
    ...
    private double cellDouble(Row row, int col, double def) {
        ...
        try { return Double.parseDouble(cellStr(row, col)); }
        catch (Exception e) { return def; }
    }
    ...
    private DifficultyLevel parseDifficulty(String s) { return LocalizedValueParser.parseDifficulty(s); }
    private MeasurementUnit parseUnit(String s)        { return LocalizedValueParser.parseUnit(s); }
}
